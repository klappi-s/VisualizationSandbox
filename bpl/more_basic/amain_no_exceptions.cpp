// Modified amain.cpp demonstrating internal error handling
#include <cassert>
#include <iostream>
#include <memory>
#include <string>
...
int main(){
    std::cout << "=== Simplified Registry Demo (No Exception Handling Needed) ===" << std::endl;
    ...
    std::cout << "\n--- Testing Type Validation (No Exceptions!) ---" << std::endl;
    ...
    std::cout << "Result: Object exists but registered = " << (invalid_dim.isRegistered() ? "YES" : "NO") << std::endl;
