...
int main(){
    ...
    std::cout << "\n--- Attempting Invalid Registrations ---" << std::endl;
    
    try {
        std::cout << "Trying to create Field<float, 3>..." << std::endl;
    ...
    try {
        std::cout << "Trying to create Field<double, 2>..." << std::endl;
    ...
    try {
        std::cout << "Trying to create ParticleBase<float, 3>..." << std::endl;
